...
public:
	...
	ClientEntry:
		...
		case '4':
		{cout << " Your current balance is: " << currentClient->getBalance() << endl << " If you want to return back to the main page press (B)" << endl;
	...
	while (indicator2) {
		...
		if (accountType == '1') {
			...
			while (indicator) {
				...
				cout << endl << " Kindly choose the number of the operation you want to make: " << endl
